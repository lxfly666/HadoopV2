 ...
 */
public class WordCountClusterDriver_CombineTextInputFormat {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException, URISyntaxException {
        ...
        conf.set("mapreduce.job.jar","E:\\Code\\2020practice\\HadoopV2_code\\out\\artifacts\\mapreduce_jar\\mapreduce.jar");
        ...
        job.setJarByClass(WordCountClusterDriver_CombineTextInputFormat.class);
